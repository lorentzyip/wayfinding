...
angular.module('wayfindingApp')
    .directive('searchText', ['$rootScope', function($rootScope) {
        return {
            restrict: 'A',
            link: function(scope, element, attrs) {
                $rootScope.$on('textKeyPressed', function(e, val, action) {
    ...
    .directive('searchFloor', ['$rootScope', function($rootScope) {
        return {
            restrict: 'A',
            link: function(scope, element, attrs) {
                $rootScope.$on('floorKeyPressed', function(e, val, action) {
                    var domElement = element[0];
                    if (document.selection) {
                        domElement.focus();
                        var sel = document.selection.createRange();
